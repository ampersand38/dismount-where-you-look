...
def main():
    ...
    print("""
  ######################################
  # DWYL Development Environment Setup #
  ######################################

  This script will create your DWYL dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your DWYL project folder:
    [Arma 3 installation directory]\\{} => DWYL project folder
    P:\\{}                              => DWYL project folder
